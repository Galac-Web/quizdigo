...
use Evasystem\Controllers\Dashboard\Dashboard;
...
try {
    ...
    switch ($type) {
        case 'add':
            ...
            $controller = new Dashboard($service);
            $result = $controller->addProfileInfo($data);
            $response = [
            'success' => true,
            'message' => 'Dashboard adăugat.',
            'data' => $result
            ];
            break;
            ...
            case 'delete':
            $service = new DashboardService();
            $res = $service->deleteDashboard($data['id']);
            $response = [
            'success' => true,
            'message' => 'Dashboard șters.',
            'data' => $res
            ];
            break;
        case 'activate':
        ...
        $_SESSION['dashboard'] = $data['id'];

        $response = [
        'success' => true,
        'message' => 'Dashboard activat în sesiune.',
